...
export default async function Page() {
  return (
    <>
      <h1 className="text-4xl font-bold">NFTEarth</h1>
      <p className="mt-4">
        An open-source alternative user interface for all things NFTEarth staking.
      </p>
      ...
      <div className="mt-10 grid gap-4 sm:grid-cols-3">
        ...
        >
          ...
          <p className="text-zinc-700 dark:text-zinc-400">
            Live staking data next to how many NFTE you can stake and daily
            rewards.
          </p>
        </Link>
        <Link
